 ...
 * == Universal Plugin ==
 *
 * Defines behavior to construct a 'com.typesafe.sbt.packager.universal' zip for installation.
 *
 * == Configuration ==
 *
 * In order to configure this plugin take a look at the available [[com.typesafe.sbt.packager.com.typesafe.sbt.packager.universal.UniversalKeys]]
 *
...
object UniversalPlugin extends AutoPlugin {
  ...
  object autoImport extends UniversalKeys {
    val Universal = config("com/typesafe/sbt/packager/universal")
    val UniversalDocs = config("com.typesafe.sbt.packager.universal-docs")
    val UniversalSrc = config("com.typesafe.sbt.packager.universal-src")
  ...
  override lazy val projectSettings = Seq[Setting[_]](
    // For now, we provide delegates from dist/stage to com.typesafe.sbt.packager.universal...
