...
trait UniversalKeys {
  ...
  val universalArchiveOptions = SettingKey[Seq[String]]("com.typesafe.sbt.packager.universal-archive-options", "Options passed to the tar/zip command. Scope by task")
}
