...
object Archives {
   ...
   */
  @deprecated(
    "Use [[com.typesafe.sbt.packager.com.typesafe.sbt.packager.universal.Archives.makeZip(File, String, Seq[(File, String)], Option[String], Seq[String]): File]]",
    since = "1.0.5"
  )
   ...
   */
  @deprecated(
    "Use [[com.typesafe.sbt.packager.com.typesafe.sbt.packager.universal.Archives.makeNativeZip(File, String, Seq[(File, String)], Option[String], Seq[String]): File]]",
    since = "1.0.5"
  )
   ...
   */
  @deprecated(
    "Use [[com.typesafe.sbt.packager.com.typesafe.sbt.packager.universal.Archives.makeDmg(target: File, name: String, mappings: Seq[(File, String)], top: Option[String], options: Seq[String]): File]]",
    since = "1.0.5"
  )
